...
public class VoidCellRecipeSelectionScreen extends AESubScreen<ContainerVoidCell, AEBaseScreen<ContainerVoidCell>> {
    ...
    public VoidCellRecipeSelectionScreen(AEBaseScreen<ContainerVoidCell> parent) {
        super(parent, "/screens/ae2mcr/condenser_selector.json");
        this.menuBridge = (VoidCellMenuBridge) parent.getMenu();
    ...
    private class RecipeListWidget implements ICompositeWidget {
        ...
        public void setPosition(Point position) {
            bounds = new Rect2i(position.getX(), bounds.getY(), bounds.getWidth(), bounds.getHeight());
            bounds = new Rect2i(bounds.getX(), position.getY(), bounds.getWidth(), bounds.getHeight());
        }
